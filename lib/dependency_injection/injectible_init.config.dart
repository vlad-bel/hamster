...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i12.ProfileEditFormSettings>(_i12.ProfileEditFormSettings());
  gh.singleton<_i13.ProfileEditUsecase>(
      _i14.ProfileEditUsecaseImpl(get<_i6.RestClient>()));
  ...
  gh.singleton<_i21.CompanyUsecase>(_i22.CompanyUseCaseImpl(
      get<_i6.RestClient>(), get<_i16.TokenRepository>()));
  gh.singleton<_i23.CountryCodeSelectorCubit>(_i23.CountryCodeSelectorCubit(
      useCase: get<_i10.NumberVerificationUseCase>()));
  gh.factory<_i24.CountrySelectorCubit>(() => _i24.CountrySelectorCubit(
      useCase: get<_i10.NumberVerificationUseCase>()));
  gh.factory<_i25.EmailVerificationCubit>(
      () => _i25.EmailVerificationCubit(get<_i4.EmailVerificationUseCase>()));
  gh.factory<_i26.ForgetPasswordCubit>(
      () => _i26.ForgetPasswordCubit(get<_i7.ForgetPasswordUseCase>()));
  ...
  gh.singleton<_i30.ProfileEditCubit>(_i30.ProfileEditCubit(
      profileEditFormSettings: get<_i12.ProfileEditFormSettings>(),
  ...
  gh.singleton<_i32.CountryCodeCubit>(_i32.CountryCodeCubit(
      useCase: get<_i10.NumberVerificationUseCase>(),
      codeSelectorCubit: get<_i23.CountryCodeSelectorCubit>()));
  gh.singleton<_i33.DashboardCubit>(
      _i33.DashboardCubit(loginUseCase: get<_i27.LoginUseCase>()));
