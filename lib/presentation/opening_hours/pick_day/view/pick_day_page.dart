...
import 'package:business_terminal/presentation/opening_hours/pick_day/cubit/pick_day_cubit.dart';
      ...
      children: OnboardingWhiteContainer(
        ...
        body: ReactiveFormBuilder(
          ...
          builder: (
            ...
            final weekDayKeys = cubit.formSettings.weekControls.keys.toList();
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      BlocBuilder<PickDayCubit, PickDayState>(
                              ...
                              return Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        state.hours.hours[index].isEmpty
                                            ? AppLocale.of(context).closed
                ...
                BlocBuilder<PickDayCubit, PickDayState>(
                  builder: (BuildContext context, state) {
                    return FormConsumer(
                      ...
                      onTap: (form) async {
                        if (state.allUnchecked && state.modified) {
                          Navigator.of(context).pop(state.hours);
                          return;
                        }
                      ...
                      enableAction: formGroup.valid ||
                          (state.allUnchecked && state.modified),
                      child: Text(
                        state.allUnchecked && state.modified
